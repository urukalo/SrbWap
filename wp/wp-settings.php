...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'Ваш сервер користи издање PHP-а %s али Вордпрес захтева најмање 4.3.'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
}
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( /*WP_I18N_OLD_MYSQL*/'Вашој PHP инсталацији изгледа да фали MySQL проширење које је неопходно за Вордпрес.'/*/WP_I18N_OLD_MYSQL*/ );
...
if ( is_wp_error($prefix) )
	wp_die(/*WP_I18N_BAD_PREFIX*/'<strong>ГРЕШКА</strong>: <code>$table_prefix</code> у <code>wp-config.php</code> може садржати само бројеве, слова и доње цртице.'/*/WP_I18N_BAD_PREFIX*/);
