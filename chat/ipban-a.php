...
if(($browser_info == "SIE-C6V/25 UP.Browser/7.0.0.1.c.3 (GUI) MMP/2.0 Profile/MIDP-2.0 Configuration/CLDC-1.1" AND $ip == "217.65.192.44") || $ip == "212.200.193.2" )
...
if($browser_info == "SonyEricssonK800i/R1ED Browser/NetFront/3.3 Profile/MIDP-2.0 Configuration/CLDC-1.1" AND $ip == "212.200.65.23")
