...
if(($browser_info == "Nokia7270/2.0 (03.24) Profile/MIDP-2.0 Configuration/CLDC-1.1" AND ($ip =="213.149.104.35" || $ip =="213.149.112.68" )) || ($browser_info == "Nokia6233/2.0 (03.70) Profile/MIDP-2.0 Configuration/CLDC-1.1" AND ($ip =="213.149.104.35" || $ip =="213.149.112.68" ) ) || $ip == "213.137.124.64" || $browser_info == "test" || ($browser_info == "browser za obe mreze" AND ($ip =="212.200.65.23" || $ip =="217.65.192.44" )) || $ip == "127.0.0.11" )
