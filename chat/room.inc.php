...
$pr_to = $m['pr_to'];
$pr_from = $m['pr_from'];
$qdblogin = @mysql_query("select `id`, `moder` from `".$px.$utable."` where `login`='$dblogin'");
...
{
if ($db['moder'] == 3) print "<b>$dblogin:</b>\r".$dbmsg." [".date("H.i",$dbtime)."]<br/>";
else print "<b><a href=\"./user.php?id=$id&amp;pass=$pass&amp;room=$room&amp;dbid=".$db['id']."&amp;r=$r\">$dblogin</a>:</b>\r".$dbmsg." [".date("H.i",$dbtime)."]<br/>";
}
}
if ($moder) {
if($mod=="privat")
