...
if($login&&$login['moder']) {
	...
	print "<b>Р‘СЂР°СѓР·РµСЂ:</b><br/>".$dbuser['soft']."<br/>"; }
	else print $lang['access_denied'];
	break;
	...
	print "</select><br/>
	<anchor>РР·РјРµРЅРёС‚СЊ<go href=\"moder.php?act=update&amp;id=$id&amp;pass=$pass&amp;mod=$mod\" method=\"post\"><postfield name=\"name\" value=\"$(name)\"/><postfield name=\"t\" value=\"$(t)\"/></go></anchor><br/>";
	} else {
